...
Custom nav extractors can be added via the plugin system. See [Writing a Plugin](/docs/plugins/writing-a-plugin/) for details on implementing the `extract_nav` hook.
