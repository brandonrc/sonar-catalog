...
Detection is dispatched through the [plugin hook system](../plugins/hooks/). The `detect_format` hook uses firstresult mode — the first plugin to return a format name wins.

## Adding Custom Formats

See [Custom Formats](./custom/) for adding your own format signatures.
